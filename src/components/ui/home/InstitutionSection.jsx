        ...
        <div className="flex flex-col md:flex-row items-center gap-16">
          ...
          <div className="md:w-1/2">
            ...
            <p className="text-gray-600 text-lg mb-8 leading-relaxed max-w-xl">
              Empower your school with the most advanced data orchestration
              platform. Transform administrative overhead into classroom
              triumphs by making every interaction count.
            </p>
