        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch">
          ...
          <div className="bg-white rounded-[2.5rem] p-10 shadow-2xl relative overflow-hidden flex flex-col items-center">
            ...
            <div className="grid grid-cols-3 gap-4 w-full mb-10">
              <div className="bg-orange-600 h-24 rounded-2xl flex items-center justify-center text-white text-xs font-bold uppercase tracking-widest p-4 text-center">
                Foundation
              </div>
              <div className="bg-yellow-500 h-24 rounded-2xl flex items-center justify-center text-white text-xs font-bold uppercase tracking-widest p-4 text-center">
                Pathways
              </div>
              <div className="bg-teal-600 h-24 rounded-2xl flex items-center justify-center text-white text-xs font-bold uppercase tracking-widest p-4 text-center">
                Impact
              </div>
            </div>
