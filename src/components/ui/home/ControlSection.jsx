          ...
          <Slider {...settings} className="control-slider">
            {[img1, img2, img3, img1, img2].map((img, index) => (
              <div key={index} className="px-4 outline-none">
                <div
                  className={`relative group transition-all duration-500 rounded-4xl overflow-hidden ${index % 2 === 0 ? "bg-green-500" : "bg-[#1A1A1A]"} p-4 pt-12 text-white`}
                >
                  ...
                  <div className="px-4 pb-4">
                    ...
                    <p className="text-white/70 text-sm mb-6">
                      Track every data point with precision and ease using our
                      dashboard.
                    </p>
